                ...
                _createClass(NegociacaoDao, [{
                    ...
                    value: function adiciona(negociacao) {
                        ...
                        return new Promise(function (resolve, reject) {
                            ...
                            request.onerror = function (e) {
                                return reject('Não foi possível adicionar a negociação');
                            };
                        });
                    }
                }, {
                    ...
                    value: function listarTodos() {
                        ...
                        return new Promise(function (resolve, reject) {
                            ...
                            cursor.onerror = function (e) {
                                return reject('Não foi possível recuperar todas as negociações');
                            };
                        });
                    }
                }, {
                    ...
                    value: function apagarTodos() {
                        ...
                        return new Promise(function (resolve, reject) {
                            ...
                            cursor.onerror = function (e) {
                                return reject('Não foi possível apagar as negociacões');
                            };
                        });
                    }
                }]);
