            ...
            _export("DateHelper", DateHelper = function () {
                ...
                _createClass(DateHelper, null, [{
                    ...
                    value: function textToDate(text) {
                        ...
                        if (!regex.test(text)) throw new Error("O texto deve estar no formato yyyy-mm-dd");

                        return new (Function.prototype.bind.apply(Date, [null].concat(_toConsumableArray(text.split("-").map(function (element, index) {
